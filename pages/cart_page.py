...
class CartPage(BasePage):
    ...
    def check_enriched_cart_page(self):
        ...
        assert self.find(cart_locators.remove_button_in_cart_loc).is_displayed(), "Кнопка удаления товара из корзины не отображается"
        ...
        assert self.find(cart_locators.apply_promocode_field_loc).is_displayed(), "Кнопка подтверждения промокода не отображается"
