...
@allure.feature("Good page")
@pytest.mark.regression
class TestGoodPage:
    @pytest.mark.smoke
    def test_good_page_displayed(self,good_page):
    ...
    @pytest.mark.smoke
    def test_add_good_in_cart(self, good_page):
    ...
    def test_category_page_search_by_valid_keyword(self, good_page):
